txt = "Computer Networks Assignment(Industry problem 1)"
...
# batch ip request
print("\n")
print("The location details of the entered ip address are:\n")
...
for port in open_ports:
    ...
    print(f"Port {port} is open on {ip_add_entered}.") #instantiate a valid ip address to test.
import ipaddress
# We need to create regular expressions to ensure that the input is correctly formatted.
import re
